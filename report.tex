...
Hence, a general guideline should be \textit{using already existing ontologies instead of creating new ones} which cover similar concepts and domains.\\

\textit{The contribution of this paper is to identify and describe these (international) best practices.}
