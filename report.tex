...
\paragraph{Shared vocabularies and data sets\footnote{\url{http://linkeduniversities.org/lu/index.php/vocabularies/index.html}}}
The list below shows common vocabularies used for describing educational and university related resources together
...
\begin{itemize}
	...
	% Example ontology http://www.questioncube.com/ldb_semantics/presentations/mathieu_d_aquin/LdB%20Semantics%20-%20Mathieu%20d'Aquin%20-%20Semantic%20Web%20Technologies.pdf
	% http://data.open.ac.uk/page/course/aa100
	\item \texttt{BIBO - The Bbibliographic Ontology}~\\
	
	\item \texttt{LSC - Linked Science Core Vocabulary}~\\
	
	\item \texttt{TEACH - Teaching Core Vocabulary\footnote{\url{http://linkedscience.org/teach/ns-20130425/}}}~\\
	The Research Core Vocabulary is a simple ontology describing educational courses and staff.
	...
	the \texttt{AIISO} - an Academic Institution Internal Structure Ontology. 
	%Example ontology: http://linkedscience.org/teach/ns-20130425/
\end{itemize}


\paragraph{Data conversion and transformation tools\footnote{\url{http://linkeduniversities.org/lu/index.php/tools/index.html}}}



\paragraph{Data sets and Endpoints\footnote{\url{http://linkeduniversities.org/lu/index.php/datasets-and-endpoints/index.html}}}
