...
%The remainder of this section outlines the \textit{Austrian Open Data}~(section \ref{sec:austrian_open_data}) project, a platform aimed at exposing governmental related data. 
